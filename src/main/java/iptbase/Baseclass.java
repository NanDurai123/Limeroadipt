	...
	public static void implicitWait(int time)
	{
		...
		TakesScreenshot ts = (TakesScreenshot) driver;
			 ...
			 File src = ts.getScreenshotAs(OutputType.FILE);
			  File dest = new File("C:\\Users\\gobiv\\eclipseworkspace\\IPT_Maven\\ScreenShot\\" + filename + ".png");
			  FileHandler.copy(src, dest);
			  }
			 
			  public static void dropDown(WebElement element, String
			 option, String value) {
...
//			  }
			 ...
			 element);
			  ...
			  public static void scrollAndPassValue(String id, String
			 value) {
			  JavascriptExecutor js = (JavascriptExecutor) driver;
			 ...
			 driver.switchTo().frame(element);// web element is used as reference
			  ...
			  {
			  driver.switchTo().frame(index);// index starts from  i.e first iframe is selected
			  }
...
//			  public static void robot(String option) {
//			   Robotr = new Robot();
